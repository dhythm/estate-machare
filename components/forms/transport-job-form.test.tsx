...
function setup(
  initial?: Parameters<typeof TransportJobForm>[0]['initial'],
  edit?: Parameters<typeof TransportJobForm>[0]['edit'],
) {
  render(
    <QueryClientProvider client={new QueryClient()}>
      <TransportJobForm initial={initial} edit={edit} />
    </QueryClientProvider>,
  )
...
describe('TransportJobForm', () => {
  it('edits an existing job with PUT', async () => {
