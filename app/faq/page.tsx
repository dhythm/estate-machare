...
const groups = [
  ...
  },
  {
    ...
    items: [
      {
        q: '物件探しと一緒に引越しも相談できますか？',
        a: '物件詳細から入居先を指定して引越しを依頼できます。現在のお住まい・荷物量・希望日を登録し、パートナーと条件を相談してください。',
      },
      {
        q: '引越し料金のめやすは確認できますか？',
        a: '荷物の規模と距離による参考額を料金ページで確認できます。デモの試算額のため、実際の費用は荷物量・建物の条件・日程を伝えて個別に確認してください。',
      },
    ],
  },
]
