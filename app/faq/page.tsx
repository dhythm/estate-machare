...
const groups = [
    ...
    items: [
      {
        ...
        a: '支払い済み賃料のうち、出品者が設定した割合（多くは 50%）を購入価格に充当します。割合と上限は詳細ページの「住んでから買う」に表示され、契約期間を入れると充当額と購入価格を確認できます。',
      },
      {
        q: 'このサービスで決済できますか？',
      ...
      {
        q: '入居中に設備が故障した場合はどうなりますか？',
        a: '出品者とのメッセージで状況を共有してください。修繕の負担区分や管理体制は、物件の詳細と申込み前のやり取りで確認できます。',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: '入居時の初期費用はどのくらいかかりますか？',
        a: '前家賃・敷金・礼金・仲介手数料の合計です。敷金と礼金は物件ごとに月数で設定され、目安は「初期費用のめやす」を参照してください。',
      },
    ],
  },
]
